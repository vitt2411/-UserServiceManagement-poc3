...
public class UserSericeImplTest {
	...
	public void getAll() {
		...
		List<User> list = Stream
				.of(new User(1, "vitthal", "wankhade", 444303, "vv@gmail.com", "12/12/12", "12/12/12", 12),
						new User(1, "vitthal", "wankhade", 444303, "vv@gmail.com", "12/12/12", "12/12/12", 12))
	...
	public void saveUserTest() {
		User user = new User(1, "vitthal", "wankhade", 444303, "vv@gmail.com", "12/12/12", "12/12/12", 12);
